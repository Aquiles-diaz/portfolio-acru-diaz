...
export default function Home() {
  return (
    ...
    >
      {/* Brillos decorativos que no interfieren */}
      <motion.div
      ...
      <TypewriterText text="¡Hola! Soy Aquiles Diaz" />

      {/* Subtítulo profesional sobrio */}
      <motion.p
        className="text-lg sm:text-xl text-emerald-400 font-semibold mt-2"
      ...
      {/* Disponibilidad y botones de contacto */}
      <motion.div
      ...
      <motion.div
        className="z-10 mt-10 flex flex-col sm:flex-row gap-4 w-full max-w-xs sm:max-w-md justify-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
